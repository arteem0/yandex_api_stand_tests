...
# Функция негативной проверки непередачи параметра firstName
...
# Тест 3. несоздание пользователя
...
#test 5  english letter in first name
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")

# test 6 russian letters in first name
...
# test 12 different type of data
